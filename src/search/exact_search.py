...
Several other tricks of A* (e.g., dynamic k-cycle conflict heuristics) are based on:
https://jair.org/index.php/jair/article/view/10835
"""
...
def exact_search(X, super_graph=None, search_method='astar',
